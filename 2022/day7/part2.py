...
# for i in sorted(filter(lambda d: type(d) is not File, base.iterdir()), reverse=False, key=lambda d: d.size):
#     print(i, i.size)

free_space = 70_000_000 - base.size
print(sorted([i for i in base.iterdir() if i.size > (30_000_000 - free_space)], reverse=False, key=lambda d: d.size)[0].size)
